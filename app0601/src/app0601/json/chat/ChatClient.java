...
public class ChatClient extends JFrame{
	...
	public ChatClient(Member member) {
		...
		p_north = new JPanel();
		t_ip = new JTextField("175.196.159.250",10);
...
//		p_north.add(bt_connect);
	...
	public void sendMsg() {
		...
		//클라이언트가 서버에 보낼 데이터가 언제나 대화메시지 만 있는것은 아니다!!
		//
		msgThread.send(member.getUser_id()+" : "+msg); //서버에 메시지 전송~(출력)
		t_input.setText(""); //초기화
	}
	
	//방법1) 채팅서버에 회원의 모든 정보를 싣어서 보내는 방법
