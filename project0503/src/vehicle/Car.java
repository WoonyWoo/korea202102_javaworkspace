...
//엔진은 보유
	...
	/*
		...
		할 수 있는데, 이 때 이 관계란 is a, has a 관계로 분류된다..
	*/
public class Car{
	Engine e; // 객체자료형은 최소한의 관여를 할 수 있다? 없다? null로 초기화됨.. null 은아무런
					//데이터가 들어있지 않다는 뜻이다.. db와 동일..
	Wheel w;
	int price; //default 값 0		기본자료형
	String color; // 객체자료형은 최소한의 관여를 할 수 있다? 없다?
